...
const PdfRenderer = ({url}: PdfRendererProps) => {
  ...
  const [renderScale, setRenderScale] = useState<number | null>(1)
        ...
        <div className="space-x-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button className="gap-1.5" aria-label='zomm' variant='ghost'>
        ...
        <SimpleBar autoHide={false} className="max-h-[calc(100vh-10rem)]">
          <div ref={ref}>
            ...
            onLoadSuccess={({ numPages }) => setNumPages(numPages)}
              ...
              {isLoading && renderScale ? <Page width={width ? width : 1} pageNumber={currPage} scale={scale} rotate={rotation} key={"@" + renderScale}/> : null}
