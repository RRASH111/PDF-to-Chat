                ...
                <div className="flex items-center justify-center h-full w-full">
                    ...
                    className="flex flex-col items-center justify-center h-full w-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-200">
                        <div className="flex flex-col items-center justify-center pt-5 pb-6"> 
                            ...
                            <p className="text-xs text-zinc-500">PDF (up to {isSubscribed ? "32" : "8"}MB)</p>
                        </div>
                        ...
                        {isUploading ? (
                            <div className="w-full mt-4 max-w-xs mx-auto">
                                ...
                                } value={uploadProgress} className="h-1 w-full bg-zinc-200 rounded-md" />
                                {uploadProgress === 100? (
                                    <div className="mt-4 text-center">
                                        <p className="text-sm text-zinc-500">Upload complete Redirecting...</p>
                                    </div>
                                ) : (
