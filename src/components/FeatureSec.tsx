          ...
          <div className="max-w-8xl -mx-52 w-fit flex flex-col items-center justify-center mr-16	">
            <div className="grid grid-cols-1 my-5 md:grid-cols-2 gap-16">
              <div className="flex flex-col items-start justify-center">
                ...
                <p className="text-gray-600 text-lg mb-8">
                  Simply upload the PDF documents you’d like to chat with. 1
                  click upload and you’re ready to go.
                </p>
            ...
            <div className="grid grid-cols-1 my-5 md:grid-cols-2 gap-16 mt-16">
              ...
              <div className="flex flex-col items-start justify-center">
                ...
                <p className="text-gray-600 text-lg mb-8">
                  ...
                  with AI. We give you instantaneous answers. Just ask.
                </p>
                <div className="flex space-x-4">
                  <Link
                    className={buttonVariants({
            ...
            <div className="grid grid-cols-1 my-5 md:grid-cols-2 gap-16">
              <div className="flex flex-col items-start justify-center">
                ...
                <p className="text-gray-600 text-lg mb-8">
                  Every response is backed by sources. extracted from the
                  uploaded document. Our AI won’t stray or give you its
                  “opinion”.
                </p>
                <div className="flex space-x-4">
                  <Link
